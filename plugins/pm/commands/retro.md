---
description: Capture what the developer had to figure out on their own during implementation, classify gaps by phase, and feed learnings back into the framework.
---
...
Spawn `.agents/skills/retrospective/dev-feedback/SKILL.md`
