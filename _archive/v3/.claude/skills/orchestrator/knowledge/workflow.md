...
doc_meta:
  ...
  summary: Maps the operational workflow for progressing work from idea through release.
  order: 0.8
  gate: meta
  requires: []
  optional: []
...
# ETUS Workflow — Phases, Outputs & Destinations
...
Vision → BO-# → **PRD-F-#** → US-# → FS-[name]-# → **Tech Spec** (NFR-#) → Arch → API/Data/UX.
