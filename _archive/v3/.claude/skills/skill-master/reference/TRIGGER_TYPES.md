...
⚠️ **All file path patterns in this guide are PLACEHOLDERS to be customized for your specific project.**

Examples like `frontend/src/**/*.tsx` or `form/src/**/*.ts` represent common project structures. **You MUST replace these with your actual directory paths.**

**Quick Customization:**
1. Identify your project structure: `ls -R` or explore in file browser
2. Replace example paths with your actual paths
3. Test using glob commands to verify matches
4. See `notes.customization_workflow` in `.claude/skills/skill-rules.json` for detailed steps
...
**⚠️ PLACEHOLDER EXAMPLE** - Replace `frontend/src` and `form/src` with YOUR actual project directories:

```json
"fileTriggers": {
  "pathPatterns": [
    "frontend/src/**/*.tsx",     // PLACEHOLDER: Replace with your frontend path
    "form/src/**/*.ts"           // PLACEHOLDER: Replace with your service path
  ],
  "pathExclusions": [
    "**/*.test.ts",
    "**/*.spec.ts"
...
**⚠️ PLACEHOLDERS** - Customize these for your project structure:

```glob
# Frontend (CUSTOMIZE: Replace 'frontend/src' with your path)
frontend/src/**/*.tsx        # All React components
frontend/src/**/*.ts         # All TypeScript files
frontend/src/components/**   # Only components directory

# Backend Services (CUSTOMIZE: Replace with your service names)
form/src/**/*.ts            # Form service (example)
email/src/**/*.ts           # Email service (example)
users/src/**/*.ts           # Users service (example)

# Database (CUSTOMIZE: Replace 'database/src' with your path)
**/schema.prisma            # Prisma schema (anywhere) - OK as-is
**/migrations/**/*.sql      # Migration files - OK as-is
database/src/**/*.ts        # Database scripts (example)

# Workflows (CUSTOMIZE: Replace 'form/src/workflow' with your path)
form/src/workflow/**/*.ts              # Workflow engine (example)
form/src/workflow-definitions/**/*.json # Workflow definitions (example)

# Test Exclusions (Usually OK as-is for most projects)
