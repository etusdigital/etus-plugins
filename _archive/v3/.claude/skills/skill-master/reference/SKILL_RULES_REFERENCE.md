...
⚠️ **The file path and content patterns in this reference are PLACEHOLDERS meant to be customized for your specific project structure.**

Examples use project-specific paths like:
- `frontend/src/**/*.tsx` - Replace with YOUR frontend directory structure
- `form/src/**/*.ts` - Replace with YOUR service directory names
- `database/src/**/*.ts` - Replace with YOUR database directory path

**Customization Workflow:**
1. Identify your project's directory structure
2. Replace placeholder paths with your actual paths
3. Test patterns match your files using glob commands
4. Adjust patterns as needed for your project

See the `notes.customization_workflow` section in skill-rules.json for detailed steps.
...
**⚠️ NOTE:** This example uses **PLACEHOLDER paths** from a specific project. You MUST customize these paths to match your project structure:
- Replace `form/src/**/*.ts` with your actual service directories
- Replace `database/src/**/*.ts` with your actual database directory
- Replace `frontend/src/**/*.tsx` with your actual frontend structure
...
**⚠️ NOTE:** This example uses **PLACEHOLDER paths** from a specific project. You MUST customize `frontend/src/features/submissions/**/*.tsx` to match your actual project structure (e.g., `app/components/**/*.tsx`, `src/pages/**/*.tsx`, etc.).
