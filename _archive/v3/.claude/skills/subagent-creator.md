...
**Description:** Comprehensive guide for creating and configuring Claude Code subagents (specialized AI assistants) using Markdown files with YAML frontmatter. This skill helps you create focused, powerful subagents that handle specific tasks with their own context and tool permissions.

**Use this skill when:** Users want to create subagents, specialize AI assistants, automate specific workflows, or need expert AI help for particular domains like code review, security audits, testing, or deployment.
